# Early History & One-Off Fixes — Big Flavor Band Agent

Archival record moved out of `MEMORY.md` during a 2026-08-01 prune. The 2025-11 section is the
original genesis timeline (reconstructed from git history on 2026-06-19); the 2026 entries are
one-off incident writeups whose lessons are folded into `ARCHITECTURE.md` / `AGENTS.md` where they're
still load-bearing.
...
[radio_streaming.md](radio_streaming.md).
