    ...
    return (
      <div className="min-h-screen bg-canvas flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-text/55">Loading...</p>
        </div>
      </div>
    );
  }
      ...
      <main className="container mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-panel rounded-lg shadow p-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <select
              ...
              className="text-sm border border-white/14 rounded-lg px-3 py-2 bg-well text-text"
            >
          ...
          <div className="bg-panel rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              {versions.map((version) => (
                <div
                  key={version.id}
                  className="flex items-center justify-between gap-4 border border-white/8 rounded-lg p-3"
                >
        ...
        {diff && (
          <div className="bg-panel rounded-lg shadow p-6">
            ...
            <div className="mb-4">
              <p className="text-sm text-text/55 mb-1">
            ...
            <table className="w-full text-sm mb-4">
              <thead>
                <tr className="text-left text-text/45">
            ...
            <div className="text-sm text-text/70 space-y-1 mb-4">
              <p>
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={discard}
                disabled={working}
                className="px-4 py-2 bg-white/8 text-text rounded-lg hover:bg-white/14 disabled:opacity-50"
              >
                Discard
              </button>
            </div>
